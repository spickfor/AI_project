...
# THIS VERSION USES SMOTE TO BALANCE THE DATA, WHICH MAY CAUSE ACCURACY ISSUES
...
# Takes unique values in POSTSEASON, later to be used for mapping encoding(Line 44) and OG so that we can output the actual rounds
...
# Balancing the dataset, This is because earlier rounds have way more datapoints than later rounds since fewer teams make it
smote = SMOTE()
